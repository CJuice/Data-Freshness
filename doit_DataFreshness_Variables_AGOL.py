...
output_excel_file_path_data_freshness_AGOL = r"DataFreshnessOutputs\AGOL_data_freshness.xlsx"
output_excel_sheetname = datetime.datetime.now().strftime('%Y%m%d')
output_json_file_path_data_freshness_AGOL = r"DataFreshnessOutputs\AGOL_data_freshness.json"
